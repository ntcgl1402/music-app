...
const LoginPrompt = () => (
    <div className='h-full flex flex-col items-center justify-center p-6 text-center space-y-4'>
        <div className='relative'>
            <div className='absolute -inset-1 bg-linear-to-r from-emerald-500 to-sky-500 rounded-full blur-lg opacity-75 animate-pulse' aria-hidden='true'/>
        ...
        <div className='space-y-2 max-w-[250px]'>
            ...
            <p className='text-sm text-zinc-400'> Login to discover music your friends are enjoying right now</p>
        </div>
    </div>
)